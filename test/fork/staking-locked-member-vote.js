...
describe('migration', function () {
  ...
  it('performs contract upgrades', async function () {
    ...
    const newTC = await TokenController.at('0xcafea42a1f81ecab1e616fa69ea14716c7ae70f1');
    const newPS = await PooledStaking.at('0xcafea458a30bbdc51078c5b68238ab7dfbb17355');
    ...
    console.log(`Params: ${[[hex('TC'), hex('PS')], [newTC.address, newPS.address]]}`);
